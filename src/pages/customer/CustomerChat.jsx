  ...
  const fetchOrder = async () => {
    try {
      ...
      if (orderDoc.exists()) {
        ...
        // Set rider name
        setRiderName(orderData.riderName || "Rider");
      } else {
    ...
    <div className="chat-container">
      ...
      <div className="messages-container" ref={messagesContainerRef}>
        {messages.length === 0 ? (
          ...
          messages.map((message) => {
            // Customer's own messages are those with senderType "customer"
      ...
      <form onSubmit={sendMessage} className="chat-input-form">
        <input
          ...
          disabled={!user}
        />
        <button type="submit" className="send-button" disabled={!newMessage.trim() || !user}>
          Send
        </button>
      </form>
    </div>
